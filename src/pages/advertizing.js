...
export default class AdvertizingPage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            modalShow: false,
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <a className="portfolio-box" href="img/portfolio/fullsize/5.jpg" onClick={this.handlePortfolioClick.bind(this, 4)}>
                                    ...
                                    <div className="portfolio-box-caption">
                                        ...
                                        <div className="project-name">
                                            Online Casino Longisland Promo
                    </div>
                                    </div>
                                </a>
                            </div>
                            <div className="col-lg-4 col-sm-6">
                                <a className="portfolio-box" href="img/portfolio/fullsize/5.jpg" onClick={this.handlePortfolioClick.bind(this, 5)}>
                                    ...
                                    <div className="portfolio-box-caption">
                                        ...
                                        <div className="project-name">
                                            Hotline 2 - Game Promotion
                    </div>
                                    </div>
                                </a>
                            </div>
                            <div className="col-lg-4 col-sm-6">
                                <a className="portfolio-box" href="img/portfolio/fullsize/5.jpg" onClick={this.handlePortfolioClick.bind(this, 6)}>
                                    ...
                                    <div className="portfolio-box-caption">
                                        ...
                                        <div className="project-name">
                                            Online Casino Exclusive Offer
                    </div>
                                    </div>
                                </a>
                            </div>
                            <div className="col-lg-4 col-sm-6">
                                <a className="portfolio-box" href="img/portfolio/fullsize/5.jpg" onClick={this.handlePortfolioClick.bind(this, 7)}>
...
export const imageData = graphql`
  query {
    images: allFile(filter: {relativePath: {glob: "portfolio/advertizing/*.jpg"}}, sort: {fields: name}) {
      edges {
        node {
          childImageSharp {
            fluid {
